...
<div class="menu3 selected"><a href="index.php?type=appointment_edit">预约</a></div>
    ...
    <tr>
        	...
        	<td style="padding-left:5px;" height="25" align="center"></td>
            		...
            		<span style="font-size:13px;font-weight:bold;">
            			<a href="http://onlineenglishpartner.taobao.com/p/EssayAimee.htm" target="_blank">Aimee</a>
            		</span>
            	</td>
                        	<td style="padding-left:5px;" height="25" align="center">
            		<span style="font-size:13px;font-weight:bold;">
            			<a href="http://onlineenglishpartner.taobao.com/p/EssayLea.htm" target="_blank">Lea</a>
            		</span>
            	</td>
                        	<td style="padding-left:5px;" height="25" align="center">
            		<span style="font-size:13px;font-weight:bold;">
            			<a href="http://onlineenglishpartner.taobao.com/p/EssayJamie.htm" target="_blank">Jamie(中教)</a>
            		</span>
            	</td>
                    </tr>
        	<tr>
