...
<div class="menu3 selected"><a href="/ourstudybuddy/${UserType}/export_Edit.do">导出xls文件</a></div>
...
<div class="buttomleft"></div>
<div class="buttomright"></div>
<div class="panelHeader">导出xls</div>
<div class="panelsubmenu">
<div style="text-align:right;padding-right:20px;">
	</div>
</div>
<form id="viewLinkForm" action="../../export_excel.php" method="POST" enctype="multipart/form-data">
	<input type="hidden" name="assistant_id" value="20"/>
<table width="50%" border="1" cellpadding="1" cellspacing="0" class="appointment_table" style='color:#4F5D66;margin: 5px 0 0 2px;'>
	<tr>
    	<td style="padding-left:5px;" height="25" align="center">预约创建开始时间：</td>
        <td style="padding-left:5px;" height="25" align="center"><input name="start_date" onclick="WdatePicker({lang:'zh-tw',dateFmt:'yyyy-MM-dd HH:mm:ss'});"/></td>
    </tr>
    <tr>
    	<td style="padding-left:5px;" height="25" align="center">预约创建结束时间：</td>
        <td style="padding-left:5px;" height="25" align="center"><input name="end_date" 
        	onclick="WdatePicker({lang:'zh-tw',dateFmt:'yyyy-MM-dd HH:mm:ss'});"/></td>
    </tr>
    <tr>
    	<td style="padding-left:5px;" height="25" align="center">预约开始日期：</td>
        <td style="padding-left:5px;" height="25" align="center"><input name="app_start_date" onclick="WdatePicker({lang:'zh-tw',dateFmt:'yyyy-MM-dd'});"/></td>
    </tr>
    <tr>
    	<td style="padding-left:5px;" height="25" align="center">预约结束日期：</td>
        <td style="padding-left:5px;" height="25" align="center"><input name="app_end_date" onclick="WdatePicker({lang:'zh-tw',dateFmt:'yyyy-MM-dd'});"/></td>
    </tr>
    <!--<tr>
    	<td style="padding-left:5px;" height="25" align="center">类型：</td>
        <td style="padding-left:5px;" height="25" align="center"><input name="type"/></td>
    </tr>
    <tr>
    	<td style="padding-left:5px;" height="25" align="center">Cycle：</td>
        <td style="padding-left:5px;" height="25" align="center"><input name="cycle"/></td>
    </tr>-->
    <tr>
    	<td style="padding-left:5px;" height="25" align="center">老师：</td>
        <td style="padding-left:5px;" height="25" align="center"><input name="teacher_name_en"/></td>
    </tr>
</table>
<table width="50%" border="0" cellpadding="1" cellspacing="0">
	<tr>
		 ...
		 <td>
		 	<input type="button" class="excel_a" value="导出">&nbsp;&nbsp;
		 </td>
    </tr>
</table>
</form>
