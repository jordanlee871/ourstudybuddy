...
<body class="index">
	...
	<div class="adminBox">歡迎你,${requestScope.UserNameType}<a href="../logout.jsp"><img src="../images/logoutbtn.gif" border="0"  class="logout"/></a></div>
	<div class="menu">
					<a href="/ourstudybuddy/${UserType}/mainpage.do" class='select' id='menu'>
						<div class='tableft'></div>
						<div class='tabcenter'>CMS</div>
						<div class='tabright'></div>
					</a>
			
					<a href="/ourstudybuddy/${UserType}/setup.do" class='' id='menu'>
						<div class='tableft'></div>
...
<div class="buttomleft"></div>
<div class="buttomright"></div>
<div class="panelHeader">新增学生</div>
...
<br/>
<form id="viewLinkForm" action="/ourstudybuddy/${UserType}/AddStudent.do" method="POST" enctype="multipart/form-data">
...
<table width="100%" border="0" cellspacing="0" style='color:#4F5D66;'>
	...
	<tr>
		 ...
		 <td><input type="text" name="wanwan" class='contentinput' value=""/>*</td>
    </tr>
    <tr>
         <td width="120" height="35" class="title">QQ:<font color="#FF0000">&nbsp;</font></td>
		 <td><input type="text" name="qq" class='contentinput' value=""/></td>
    </tr>
    <tr>
         <td width="120" height="35" class="title">手机:<font color="#FF0000">&nbsp;</font></td>
		 <td><input type="text" name="phone" class='contentinput' value=""/>*</td>
    </tr>
    <tr>
         <td width="120" height="35" class="title">邮箱:<font color="#FF0000">&nbsp;</font></td>
		 <td><input type="text" name="email" value="" class="contentinput validate[required,custom[email]]" id="email"/>*</td>
    </tr>
  	
	<tr>
         <td width="120" height="35" class="title">注册时间:<font color="#FF0000">&nbsp;</font></td>
		 <td><input type="text" name="real_name" class='contentinput' value="" readonly="readonly"/></td>
    </tr>
	<tr>
	...
	<tr>
		 ...
		 <td>
		 	<input type="submit" name="publish" class="commmonBtn" value="Save" onClick="submitform('/ourstudybuddy/${UserType}/AddStudent.do','/ourstudybuddy/${UserType}/student_Edit.do');">&nbsp;&nbsp;
			<input type="button" name="back" class="commmonBtn" value="Back" onClick="submitback('/ourstudybuddy/${UserType}/student_Edit.do');">
            		 </td>
    </tr>
</table>
</form>
