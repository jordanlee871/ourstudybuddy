...
<table width="100%" border="0" cellspacing="0" style='color:#4F5D66;'>
    ...
    <tr height='15'>
		...
		<td style="padding-left:5px;" height="25">2014-6-11 23:15PM</td>
...
<table width="100%" border="0" cellspacing="0">
    ...
    <tr>
	  ...
	  <a href="/ourstudybuddy/${UserType}/studentfirstpage.do">首頁</a>&nbsp;&nbsp;&nbsp;&nbsp; 
	  <a href="/ourstudybuddy/${UserType}/studentpreviouspage.do">上一頁</a>&nbsp;&nbsp;&nbsp;&nbsp; 
	  <a href="/ourstudybuddy/${UserType}/studentnextpage.do">下一頁</a>&nbsp;&nbsp;&nbsp;&nbsp; 
	  <a href="/ourstudybuddy/${UserType}/studentlastpage.do">末頁</a>&nbsp;&nbsp;&nbsp;&nbsp; 
	  <select onchange="javascript:submitback('/ourstudybuddy/${UserType}/studentessayselect.do?page='+ this.options[this.selectedIndex].value)">
