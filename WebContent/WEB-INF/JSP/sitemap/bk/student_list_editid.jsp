...
-->
<form id="viewLinkForm" action="/ourstudybuddy/system/studentdetailsave.do" method="GET" >
...
<table width="100%" border="0" cellspacing="0" style='color:#4F5D66;'>
	...
	<tr>
		 ...
		 <td>
		 	<input type="submit" name="publish" class="commmonBtn" value="Save" />
			<input type="button" name="back" class="commmonBtn" value="Back" onClick="submitback('/ourstudybuddy/system/studentessayback.do');"/>
			...
			<input type="button" name="charge" class="commmonBtn" value="退款" onClick="do_function('do_refund','2236','index.php?type=student_edit&backType=student_list&editId=2236','即将为学生soliloquy28退款，请确认');"/>
            		 </td>
    </tr>
</table>
</form>
