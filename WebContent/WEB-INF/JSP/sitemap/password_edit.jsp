...
<body class="index">
	...
	<div class="adminBox">歡迎你,${	UserNameType}<a href="../logout.php"><img src="../images/logoutbtn.gif" border="0"  class="logout"/></a></div>
	<div class="menu">
					<a href="index.php?ac=cms" class='' id='menu'>
						<div class='tableft'></div>
						<div class='tabcenter'>CMS</div>
						<div class='tabright'></div>
					</a>
			
					<a href="index.php?ac=set" class='select' id='menu'>
						<div class='tableft'></div>
		  ...
		  <tr>
			<td height="445" valign="top" class="leftlayout">
				  ...
				  <div class="menu1" id='leftmenu'>	
						<div class="menu2">
<a href="#">Setting</a>
<div class="menu3 selected"><a href="index.php?type=password_edit">Change Password</a></div>
</div>
				  </div>
...
<div class="buttomleft"></div>
<div class="buttomright"></div>
<div class="panelHeader"><div style="text-align:left;padding-right:20px;">Change Password</div> </div>
<div class="panelsubmenu"></div> 
<br />
<form name="viewLinkForm" id="viewLinkForm" method="post" action='/ourstudybuddy/${UserType}/change_password.do'>
<table width="100%" border="0">
	<tr>
		<td class="title" height="35" style="width:100px">Account:</td>
		<td>{UserNmae}</td>
	</tr>
	
	<tr>
		<td class="title" height="35" style="width:100px">New Password:</td>
		<td><input type="password" name="newpwd" id="newpwd" class='contentinput' value="" size="30"><br /></td>
	</tr>
	
	<tr>
		<td class="title" height="35" style="width:100px">Confirm Password:</td>
		<td><input type="password" name="conpwd" id="conpwd" class='contentinput' value="" size="30"><br /></td>
	</tr>
	
	<tr>
	<td></td>
	<td>
				<input type="hidden" name="editId" value='20'/>
				<input type="submit" name="approve" class="commmonBtn" value="Update" onclick="submitform('/ourstudybuddy/${UserType}/change_password.do','/ourstudybuddy/${UserType}/setup.do');"></td>
	</tr>
</table>
</form>
</div>					 </div>
